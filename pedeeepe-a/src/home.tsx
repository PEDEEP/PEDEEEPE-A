    ...
    <>
      ...
      <div class="wrapper">
        <div>
          ...
          <p>
            ประชุม หัวข้องาน และ ความต้องการของลูกค้า ที่ต้องการ product โง่่ๆ
            สร้างความไร้สาระกับลูกค้าให้มากที่สุด ในงาน Stupid hackation
          </p>
        </div>
        <div>
          ...
          <p>
            การฝึกอบรมและศึกษา การใช้งาน Kotchasan framework ของภาษา PHP
            ที่ดีที่สุดในตลาด ณ เวลานี้
          </p>
        </div>
        <div>
          ...
          <p>
            การแก้ไขซอฟแวร์เฉพาะหน้าหรือเรียกว่า บัค มันไม่เป็นความจริงเลย
            เพราะบัคเท่ากับฟีเจอร์ ของ แอปที่ดีๆ
          </p>
        </div>
        <div>
          ...
          <p>
            การประชุมเล็กๆที่จัดขึ้นทุกวัน ที่มีแต่ การพูดถึง สิ่งเดิมๆ
            ไม่ไปข้างหน้าๆ หัวหน้าก็คนเดิม เพื่อนร่วมงานก็คนเดิม
          </p>
        </div>
        <div>
          ...
          <p>
            การประชุมร่วมของ dev ที่มี่ ปัญหา ระหว่าง front end กับ backend
            ใครต่อAPI กันแน่ ส่วน UI/UX designer ออกแบบจนdevทำ ไม่ทัน ส่วน
            devops ก็ server ล่ม{" "}
          </p>
        </div>
        <div>
          ...
          <p>
            CEO ได้สรุปผลงานของ Dev เดือน กรกฎาคม งานตองดเลย 2เดือน เพราะ
            บริษัทมุ่งเน้น จักรวาลนฤมิตร มากเกินไปจนล่ม product ก่อนหน้านี้ และ พนักงานได
            lay-out จนบริษัทล้มละลาย
          </p>
        </div>
      </div>
    </>
